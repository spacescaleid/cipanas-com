// src/components/admin/ArticleFilterBar.tsx
...
const filters: {
  ...
  { key: "PENDING", label: "Menunggu Review", priority: true },
  { key: "REVISION", label: "Sedang Revisi" },
...
export function ArticleFilterBar({ current, counts }: Props) {
  return (
