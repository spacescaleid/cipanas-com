        ...
        <div className="space-y-6">
          ...
          <div className="rounded-xl border border-neutral-200 bg-white p-6 dark:border-neutral-800 dark:bg-neutral-900">
            <div className="mb-3 flex items-start justify-between gap-4">
              ...
              <span
                className={`shrink-0 inline-flex items-center rounded-md border px-2.5 py-1 text-xs font-semibold ${statusColor.bg} ${statusColor.text} ${statusColor.border}`}
              >
            ...
            <div className="grid grid-cols-2 gap-4 border-t border-neutral-100 pt-4 text-sm dark:border-neutral-800">
              <div>
                <p className="text-xs text-neutral-500">YouTube ID</p>
          ...
          <div className="rounded-xl border border-neutral-200 bg-white p-5 dark:border-neutral-800 dark:bg-neutral-900">
            ...
            <div className="space-y-2 text-sm">
              ...
              {video.publishedAt && (
                <div className="flex items-center justify-between">
                  <span className="inline-flex items-center gap-1.5 text-neutral-600 dark:text-neutral-400">
                    <Calendar className="h-4 w-4" /> Tayang
                  </span>
                  <span className="text-xs text-neutral-700 dark:text-neutral-300">
